...
<input type="hidden" name="type" value="preset-posttype" />
    ...
    <tr>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_docs'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_docs'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_faq'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_faq'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_music'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_music'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_portfolio'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_portfolio'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_teams'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_teams'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_testimonials'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_testimonials'] ); }?>"></span></td>
        ...
        <td class="td10 textcenter"><span class="<?php if( isset( $posttype['dashicons_picker_videos'] ) ) {?>dashicons <?php echo esc_attr( $posttype['dashicons_picker_videos'] ); }?>"></span></td>
